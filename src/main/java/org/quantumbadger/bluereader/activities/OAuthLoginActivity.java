...
import org.quantumbadger.bluereader.BlueReader;
...
public class OAuthLoginActivity extends BaseActivity {
	...
	public void onCreate(final Bundle savedInstanceState) {
		...
		if(TorCommon.isTorEnabled()) {
			try {
				boolean result = WebkitProxy.setProxy(BlueReader.class.getCanonicalName(), getApplicationContext(), mWebView, "127.0.0.1", 8118);
				if(!result) {
