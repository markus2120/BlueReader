	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		send.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				sb.append("Error report -- BlueReader v").append(Constants.version(BugReportActivity.this)).append("\r\n\r\n");
				...
				intent.putExtra(Intent.EXTRA_EMAIL, new String[] {"bug" + "reports" + '@' + "bluereader" + '.' + "org"}); // no spam, thanks
