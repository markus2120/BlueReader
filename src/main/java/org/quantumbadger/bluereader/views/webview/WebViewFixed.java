...
package org.quantumbadger.bluereader.views.webview;
...
public class WebViewFixed extends WebView {
	...
	private void setTor(final Context context) {
		if(TorCommon.isTorEnabled()) {
			try {
				clearBrowser();
				boolean result = WebkitProxy.setProxy(BlueReader.class.getCanonicalName(), context.getApplicationContext(), this, "127.0.0.1", 8118);
				if(!result) {
